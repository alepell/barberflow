  ...
  return (
    <div className="rounded-2xl border border-gray-800 bg-gray-900 p-8 shadow-xl">
      <div className="mb-6 text-center">
        ...
        <p className="mt-1 text-sm text-gray-400">Entre na sua conta</p>
      </div>
      ...
      <div className="mt-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-700 bg-gray-800 py-2.5 text-sm font-medium text-white transition-colors hover:bg-gray-700"
        >
